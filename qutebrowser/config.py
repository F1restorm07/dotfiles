...
c.colors.completion.item.selected.bg = nord['nord6']
...
c.colors.downloads.system.bg = 'none' # color interpolation system for download backgrounds
...
c.colors.keyhint.suffix.fg = nord['nord1']
...
c.colors.statusbar.insert.bg = nord['nord15']
